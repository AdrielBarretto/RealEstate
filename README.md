The code a.csv has been shared to those who need it     
(Professor Brown, it is in a slack message on November 13th at  3:09 pm (direct message to you on 5430 server). You will have to rename it to a.csv when you open the zip file).     
